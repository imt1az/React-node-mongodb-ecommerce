  ...
  <div className="px-6 h-full text-gray-800">
    ...
    >
      ...
      <div class="flex flex-row items-center justify-center lg:justify-start">
            <p class="text-lg mb-0 mr-4">{formType ? 'Register with' : 'Sign in with'}</p>
            <button
              type="button"
       ...
       />
        ...
        <div className="text-center lg:text-left">
            ...
            <button onClick={()=> toggleFormType()} type="button" className="inline-block px-6 py-2 border-2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
               {
